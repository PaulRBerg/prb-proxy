...
const _abi = [
  ...
  },
  {
    ...
    name: "PRBProxy__ExecutionUnauthorized",
    type: "error",
  },
  {
    inputs: [],
...
type PRBProxyConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: PRBProxyConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class PRBProxy__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PRBProxy> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): PRBProxy {
